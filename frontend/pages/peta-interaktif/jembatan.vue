  ...
  <div class="app">
    ...
    >
      ...
      <div
        ...
        :style="getBackgroundStyle('/slider/jembatan_lingkungan.png')"
      >
      ...
      <div class="hero-content relative z-10">
        <div class="hero-text">
          ...
          <p class="hero-description" data-aos="fade-up" data-aos-delay="400">
            Platform WebGIS untuk pengelolaan data jembatan lingkungan di Kabupaten
            Kubu Raya. Menyajikan informasi kondisi jembatan, material struktur,
        ...
        <div id="map-canvas" class="map-title-frame">
          <div class="title-frame-content">
            <h3 class="map-title-text">
              Sistem Informasi Jembatan Lingkungan Kab. Kubu Raya
            </h3>
          </div>
        </div>
        <!-- Map Canvas -->
    ...
    <section id="analisis" class="analisis-section">
      <div class="section-header" data-aos="fade-up">
        <h2 class="section-title">Analisis Kondisi & Kerusakan Jembatan</h2>
        <p class="section-description">
          Visualisasi dan analisis mendalam kondisi jembatan berdasarkan tingkat
        ...
        <div class="analisis-grid">
          ...
          <div class="analisis-card" data-aos="fade-up" data-aos-delay="100">
            <div class="card-header">
              <h3 class="card-title">Analisis Kondisi & Material Jembatan</h3>
            ...
            <div class="dual-donut-container">
              ...
              <div class="donut-section">
                <h4 class="donut-title">Kondisi Jembatan</h4>
              ...
              <div class="donut-section">
                <h4 class="donut-title">Material Jembatan</h4>
                <div class="donut-chart">
          ...
          <div class="analisis-card" data-aos="fade-up" data-aos-delay="400">
            <div class="card-header">
              <h3 class="card-title">Jumlah Jembatan per Kecamatan</h3>
              <svg
                class="w-5 h-5 text-gray-400"
                fill="none"
                stroke="currentColor"
...
// Set page meta
useHead({
  title: "Sistem Informasi Jembatan Lingkungan Kab. Kubu Raya",
  meta: [
    {
      name: "description",
      content:
        "Web GIS untuk Sistem Informasi Jembatan Lingkungan menggunakan ArcGIS JS API",
    },
  ],
});
</script>
