  ...
  <div class="app overflow-x-hidden">
    ...
    >
      ...
      <div
        ...
        :style="getBackgroundStyle('/slider/drainase_lingkungan.png')"
      >
      ...
      <div class="hero-container">
        ...
        <div class="hero-content-center" data-aos="fade-up">
          <h1 class="hero-title-main">Drainase Lingkungan</h1>
          <h2 class="hero-subtitle">Sistem Informasi Drainase Lingkungan</h2>
          <p class="hero-description-text">
            Sistem informasi geografis yang menyediakan data dan peta interaktif
            mengenai drainase lingkungan di Kabupaten Kubu Raya, termasuk
            informasi jaringan drainase, kondisi, dan kapasitas untuk mendukung
            pengelolaan sistem drainase yang efektif.
          </p>
        </div>
        ...
        <div class="hero-stats" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="stat-card">
            ...
            <div class="stat-content">
              ...
              <p class="stat-label">Drainase Kondisi Baik</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="map" class="map-section">
      <div class="section-header" data-aos="fade-up">
        ...
        <p class="section-description">
          Jelajahi data drainase lingkungan melalui peta interaktif dengan
        ...
        <div id="map-canvas" class="map-title-frame">
          <div class="title-frame-content">
            <h3 class="map-title-text">
              Sistem Informasi Drainase Lingkungan Kab. Kubu Raya
            </h3>
          </div>
        </div>
        <!-- Map Canvas -->
          ...
          >
            <div class="text-center z-10">
              ...
              <p class="text-sm text-gray-500 mt-2">
                Fitur peta interaktif drainase lingkungan sedang dalam
                pengembangan
              </p>
            </div>
          </div>
    ...
    <section id="analisis" class="analisis-section">
      <div class="section-header" data-aos="fade-up">
        <h2 class="section-title">Analisis Kondisi & Kerusakan Drainase</h2>
        <p class="section-description">
          Visualisasi dan analisis mendalam kondisi drainase berdasarkan tingkat
      ...
      <div class="development-alert" data-aos="fade-up" data-aos-delay="50">
        ...
        <div>
          ...
          <p class="alert-description">
            Dashboard analisis dan statistik drainase sedang disiapkan. Insight
            lengkap akan tersedia pada rilis berikutnya.
          </p>
        </div>
      </div>
        ...
        <div class="analisis-grid">
          ...
          <div class="analisis-card" data-aos="fade-up" data-aos-delay="100">
            <div class="card-header">
              <h3 class="card-title">Analisis Kondisi & Material Drainase</h3>
            ...
            <div class="dual-donut-container">
              ...
              <div class="donut-section">
                <h4 class="donut-title">Kondisi Drainase</h4>
              ...
              <div class="donut-section">
                <h4 class="donut-title">Material Drainase</h4>
                <div class="donut-chart">
          ...
          <div class="analisis-card" data-aos="fade-up" data-aos-delay="400">
            <div class="card-header">
              <h3 class="card-title">Panjang Drainase per Kecamatan</h3>
              <svg
                class="w-5 h-5 text-gray-400"
                fill="none"
                stroke="currentColor"
...
// Set page meta
useHead({
  title: "Sistem Informasi Drainase Lingkungan Kab. Kubu Raya",
  meta: [
    {
      name: "description",
      content:
        "Web GIS untuk Sistem Informasi Drainase Lingkungan menggunakan ArcGIS JS API",
    },
  ],
});
</script>
                  ...
                  tooltip: {
                    ...
                    callbacks: {
                      label: function (context) {
                        return "Panjang Drainase: " + context.parsed.x + " km";
                      },
                    },
                  },
                },
