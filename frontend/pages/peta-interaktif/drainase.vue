      ...
      <div class="hero-content relative z-10">
        <div class="hero-text">
          ...
          <p class="hero-description" data-aos="fade-up" data-aos-delay="400">
            Platform WebGIS untuk pengelolaan data drainase lingkungan di Kabupaten
            Kubu Raya. Menyajikan informasi kondisi drainase, material struktur,
    ...
    <section id="map" class="map-section">
      ...
      <div class="section-header" data-aos="fade-up">
        ...
        <p class="section-description">
          Jelajahi data drainase lingkungan melalui peta interaktif dengan berbagai
        ...
        <div class="map-canvas-wrapper relative" style="pointer-events: none;">
          <div class="absolute inset-0 bg-gray-100 flex items-center justify-center">
            <div class="text-center z-10">
              ...
              <p class="text-sm text-gray-500 mt-2">Fitur peta interaktif drainase lingkungan sedang dalam pengembangan</p>
            </div>
          </div>
        </div>
      </div>
