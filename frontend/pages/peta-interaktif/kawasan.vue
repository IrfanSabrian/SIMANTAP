      ...
      <div class="hero-content relative z-10">
        <div class="hero-text">
          ...
          <p class="hero-description" data-aos="fade-up" data-aos-delay="400">
            Platform WebGIS untuk pengelolaan data kawasan permukiman di
            Kabupaten Kubu Raya. Menyajikan informasi kondisi kawasan,
            karakteristik permukiman, dan analisis spasial untuk mendukung
            pengambilan keputusan dalam perencanaan dan pengembangan permukiman.
          </p>
