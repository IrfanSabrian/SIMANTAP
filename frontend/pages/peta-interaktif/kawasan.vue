  ...
  <div class="app overflow-x-hidden">
    ...
    >
      ...
      <div
        ...
        :style="getBackgroundStyle('/slider/kawasan_permukiman.png')"
      >
      ...
      <div class="hero-container">
        ...
        <div class="hero-content-center" data-aos="fade-up">
          <h1 class="hero-title-main">Kawasan Permukiman</h1>
          <h2 class="hero-subtitle">Sistem Informasi Kawasan Permukiman</h2>
          <p class="hero-description-text">
            Sistem informasi geografis yang menyediakan data dan peta interaktif mengenai 
            kawasan permukiman di Kabupaten Kubu Raya, termasuk informasi sebaran, karakteristik, 
            dan kondisi kawasan untuk mendukung perencanaan dan pengembangan permukiman yang berkelanjutan.
          </p>
        </div>
        ...
        <div class="stat-card">
          ...
          <div class="stat-content">
            ...
            <p class="stat-label">Kawasan Layak Huni</p>
          </div>
        </div>
      </div>
      </div>
    ...
    <section id="map" class="map-section">
      <div class="section-header" data-aos="fade-up">
        ...
        <p class="section-description">
          Jelajahi data kawasan permukiman melalui peta interaktif dengan
        ...
        <div id="map-canvas" class="map-title-frame">
          <div class="title-frame-content">
            <h3 class="map-title-text">
              Sistem Informasi Kawasan Permukiman Kab. Kubu Raya
            </h3>
          </div>
        </div>
        <!-- Map Canvas -->
          ...
          >
            <div class="text-center z-10">
              ...
              <p class="text-sm text-gray-500 mt-2">
                Fitur peta interaktif kawasan permukiman sedang dalam
                pengembangan
              </p>
            </div>
          </div>
    ...
    <section id="analisis" class="analisis-section">
      <div class="section-header" data-aos="fade-up">
        <h2 class="section-title">Analisis Kawasan Permukiman</h2>
        <p class="section-description">
          Visualisasi dan analisis mendalam kawasan permukiman berdasarkan
          karakteristik permukiman, kondisi kawasan, dan sebaran geografis di
          Kabupaten Kubu Raya.
        </p>
      </div>
      <div class="development-alert" data-aos="fade-up" data-aos-delay="50">
        ...
        <div>
          ...
          <p class="alert-description">
            Analisis dan statistik kawasan permukiman sedang dikembangkan dan
            akan dirilis setelah integrasi data selesai.
          </p>
        </div>
      </div>
        ...
        <div class="analisis-grid">
          ...
          <div class="analisis-card" data-aos="fade-up" data-aos-delay="100">
            <div class="card-header">
              <h3 class="card-title">
                Analisis Kondisi & Karakteristik Kawasan
              </h3>
            ...
            <div class="dual-donut-container">
              ...
              <div class="donut-section">
                <h4 class="donut-title">Kondisi Kawasan</h4>
              ...
              <div class="donut-section">
                <h4 class="donut-title">Karakteristik Kawasan</h4>
                <div class="donut-chart">
          ...
          <div class="analisis-card" data-aos="fade-up" data-aos-delay="400">
            <div class="card-header">
              <h3 class="card-title">Luas Kawasan per Kecamatan</h3>
              <svg
                class="w-5 h-5 text-gray-400"
                fill="none"
                stroke="currentColor"
...
// Set page meta
useHead({
  title: "Sistem Informasi Kawasan Permukiman Kab. Kubu Raya",
  meta: [
    {
      name: "description",
      content:
        "Web GIS untuk Sistem Informasi Kawasan Permukiman menggunakan ArcGIS JS API",
    },
  ],
});
</script>
                  ...
                  tooltip: {
                    ...
                    callbacks: {
                      label: function (context) {
                        return "Luas: " + context.parsed.x + " km²";
                      },
                    },
                  },
                },
