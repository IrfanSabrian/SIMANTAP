      ...
      <div class="hero-content relative z-10">
        <div class="hero-text">
          ...
          <p class="hero-description" data-aos="fade-up" data-aos-delay="400">
            Platform WebGIS untuk pengelolaan data rumah tidak layak huni di Kabupaten
            Kubu Raya. Menyajikan informasi kondisi rumah, karakteristik permukiman,
            dan analisis kerusakan untuk mendukung pengambilan keputusan dalam
            perencanaan dan rehabilitasi perumahan.
          </p>
