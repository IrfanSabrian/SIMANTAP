      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center">
          ...
          <p class="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Fitur Data Jembatan Lingkungan saat ini sedang dalam tahap
            pengembangan. Halaman ini akan segera tersedia dengan data lengkap
            jembatan lingkungan di Kabupaten Kubu Raya.
          </p>
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">
                    Informasi detail jembatan termasuk lokasi, kondisi, dan
                    spesifikasi teknis
                  </p>
                </div>
              </div>
