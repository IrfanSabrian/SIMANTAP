      ...
      <div class="max-w-4xl mx-auto text-center">
        <div class="mb-8">
          ...
          <p class="text-xl text-gray-600 mb-8">
            Halaman data tabel untuk Rumah Tidak Layak Huni akan segera hadir.
            Silakan kunjungi halaman Peta Interaktif untuk melihat data dalam format peta.
          </p>
        </div>
...
useHead({
  ...
  meta: [
    {
      name: "description",
      content: "Data tabel Rumah Tidak Layak Huni - Halaman dalam pengembangan",
    },
  ],
});
</script>
